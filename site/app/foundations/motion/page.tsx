...
export default function MotionPage() {
  return (
    <DocsShell currentPath="/foundations/motion" title="Motion" description="Foundation guidance page prepared for the next content hardening pass." status="draft" related={getRelatedLinks(["/foundations/colors", "/components/primitives"])}>
