...
export default function TypographyPage() {
  return (
    <DocsShell currentPath="/foundations/typography" title="Typography" description="Foundation guidance page prepared for the next content hardening pass." status="draft" related={getRelatedLinks(["/foundations/colors", "/components/primitives"])}>
