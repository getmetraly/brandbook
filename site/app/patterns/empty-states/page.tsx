...
export default function EmptyStatesPage() {
  return (
    <DocsShell currentPath="/patterns/empty-states" title="Empty States" description="Pattern page scaffold prepared for content extraction from the legacy draft sandbox." status="draft" related={getRelatedLinks(["/components/forms", "/components/dashboard"])}>
