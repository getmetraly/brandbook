...
export default function FiltersPage() {
  return (
    <DocsShell currentPath="/patterns/filters" title="Filters" description="Pattern page scaffold prepared for content extraction from the legacy draft sandbox." status="draft" related={getRelatedLinks(["/components/forms", "/components/dashboard"])}>
