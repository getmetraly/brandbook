...
export const FirstStep: Story = {
  ...
  render: () => (
    <div style={stageStyle}>
      <div style={frameStyle}>
        <StickyWizardFooter
          primary={<MetralyButton variant="primary">Get started</MetralyButton>}
        />
      </div>
    </div>
  ),
...
export const Submitting: Story = {
  ...
  render: () => (
    <div style={stageStyle}>
      <div style={frameStyle}>
        <StickyWizardFooter
          back={<MetralyButton variant="ghost" disabled>Back</MetralyButton>}
          primary={<MetralyButton variant="primary" disabled>Creating…</MetralyButton>}
        />
      </div>
    </div>
  ),
  ...
  render: () => (
    <div style={stageStyle}>
      <div style={frameStyle}>
        <StickyWizardFooter
          back={<MetralyButton variant="ghost">Back</MetralyButton>}
          status={<MetralyBadge variant="error">Save failed — retry</MetralyBadge>}
          primary={<MetralyButton variant="primary">Retry</MetralyButton>}
        />
      </div>
    </div>
  ),
  ...
  render: () => (
    <div style={stageStyle}>
      <div style={frameStyle}>
        ...
        <StickyWizardFooter
          back={<MetralyButton variant="ghost">Back</MetralyButton>}
          primary={<MetralyButton variant="primary">Save and continue</MetralyButton>}
        />
      </div>
    </div>
  ),
