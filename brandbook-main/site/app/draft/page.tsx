    ...
    <main>
      <section className="shell hero component-hero draft-review-hero">
        <div>
          ...
          <h1>Draft component patterns in real Metraly product scenarios.</h1>
          <p className="lead">
            A tighter /draft hardening pass built on /components: pulse-wave hero, calmer spacing, clearer widget-registry mapping, dropdown coverage and stronger drag-and-drop examples.
          </p>
          <span className="draft-pulse-line is-hero" aria-hidden="true" />
          <div className="actions">
            <a className="btn btn-primary" href="#screen-01">Controls</a>
            <a className="btn btn-secondary" href="#screen-02">Charts & DnD</a>
            <a className="brand-btn brand-btn-ghost" href="#screen-03">Product pages</a>
          </div>
        </div>

        <aside className="panel draft-review-summary-card">
          <span className="draft-review-kicker">Rules</span>
          <strong>/components stays baseline. /draft is the hardening lab.</strong>
          <p>The old Metric source select example stays excluded, while dropdown is reviewed as a separate menu pattern.</p>
